...
XERO_CLIENT_SECRET_NAME=""
XERO_CLIENT_SECRET_NAMESPACE=""
XERO_CLIENT_SECRET_KEY=""
# Name of the branding theme for Batch Invoices
XERO_BATCHINVOICEBRANDINGTHEME=""
